...
<div class="background">
      ...
      <div class="row2" style="text-align:center;">
        <button onclick="schoolWiseGpa()" style="background:#FE818F;" class="School-wise">School-wise GPA Trend</button>
        <button onclick="departmentWiseGpa()" style="background:#FE818F;" class="Department-wise">Department-wise GPA Trend</button>
        <button onclick="programWiseGpa()" style="background:#FE818F;" class="Program-wise">Program-wise GPA Trend</button>
      </div>
