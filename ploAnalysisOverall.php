  ...
  <body>
    ...
    <div class="navbar"> 
      ...
      <div style="height:80px;"class="row1">
        ...
        <input style="background-color:#FE818F;border-radius:10px; border:none;outline:none;color:#fff;font-size:14px;
      ...
      <div style="display:flex;justify-content:space-around" class="row2">
        <button onclick="overallPlo()"style="background-color:#FE818F;" style="width:300px;margin-left:0px;" class="School-wise">Overall PLO</button>
        <button onclick="coWisePlo()"style="background-color:#FE818F;" style="width:300px;" class="Department-wise">CO Wise PLO</button>
        <button onclick="courseWisePlo()"style="background-color:#FE818F;" style="width:300px;" class="Program-wise">Course Wise PLO</button>
      </div>
