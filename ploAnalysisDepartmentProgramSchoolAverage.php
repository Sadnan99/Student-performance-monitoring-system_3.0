  ...
  <body>
   ...
   <div class="navbar"> 
       ...
       <a class="navbar-brand" href="employee_dashboard.php">SPMS</a>
        ...
        <a href="ploAnalysisDepartmentProgramSchoolAverage.php" target="_self">PLO Analysis With Department/Program/School Average</a>

        <a href="ploAnalysisOverall.php" target="_self">PLO Analysis (Overall, CO Wise, Course Wise)</a>

        <a href="employee_dashboard.php" target="_self">Logout</a>
      </div>
      ...
      <div style="height:80px;"class="row1">
        <form method="POST">
        <input style="background-color:#FE818F ;height:50px;border: 1px solid;cursor: pointer;border-radius: 5px;font-size: 14px;letter-spacing:2px;
        ...
        <input style="background:#FE818F;border-radius:10px; border:none;outline:none;color:#fff;font-size:14px;
      ...
      <div style="display:flex;justify-content:space-around" class="row2">
        <button onclick="ploAnalysisWithDepartmentAverage()" style="background:#FE818F;" style="width:300px;margin-left:0px;" class="School-wise">PLO Analysis with Department Average</button>
        <button onclick="ploAnalysisWithProgramAverage()" style="background:#FE818F;" style="width:300px;" class="Department-wise">PLO Analysis with Program Average</button>
        <button onclick="ploAnalysisWithSchoolAverage()"style="background:#FE818F;" style="width:300px;" class="Program-wise">PLO Analysis with School Average</button>
      </div>
