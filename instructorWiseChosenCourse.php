  ...
  <body>
    ...
    <div class="navbar"> 
      ...
      <form method="POST">
        ...
        <select style="background-color:#FE818F;" name="courseCode" class="select"
      ...
      <button onclick="viewInstructorWiseChosenCourse()" style="height: 46px;width: 100px;margin-left:50px;display:inline-block; border-radius: 10px; border: none;outline: none;background:#FE818F;color: #fff;font-size: 14px;letter-spacing:2px;text-transform: uppercase;cursor:pointer;font-weight: bold;">
        view</button>
      </div>
