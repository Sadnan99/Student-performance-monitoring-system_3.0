...
--
-- Table structure for table `backlog_t`
--

CREATE TABLE `backlog_t` (
  `spdID` int(255) NOT NULL,
  `id` int(255) NOT NULL,
...
--
-- Dumping data for table `backlog_t`
--

INSERT INTO `backlog_t` (`spdID`, `id`, `year`, `semester`, `course`, `section`, `grade`, `facultyID`, `date`, `time`) VALUES
(8, 1911034, 2023, 'Spring', 'MAT301', 5, 'B+', 2259, '2023-04-26', '19:30:54'),
(9, 1927465, 2025, 'Spring', 'BIO', 2, 'A', 2259, '2023-04-26', '19:32:08');
...
(24, 5, 'Spring', 'MAT301', 2259, 2023),
(25, 2, 'Spring', 'BIO', 2259, 2025);
...
(1911034, '', '', '0000-00-00', '', '', '', '', '', 0, '', 'Spring', '2023'),
...
(1927465, '', '', '0000-00-00', '', '', '', '', '', 0, '', 'Spring', '2025'),
...
--
-- Indexes for table `backlog_t`
--
ALTER TABLE `backlog_t`
  ADD PRIMARY KEY (`spdID`);
...
--
ALTER TABLE `answer_t`
  MODIFY `answerID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=126;

--
-- AUTO_INCREMENT for table `backlog_t`
--
ALTER TABLE `backlog_t`
  MODIFY `spdID` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `registration_t`
  MODIFY `registrationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
