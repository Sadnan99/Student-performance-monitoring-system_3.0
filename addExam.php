...
<html lang="en">
  ...
  <body>
    <div class="navbar"> 
        ...
        <a href="addExam.php" target="_self">Add Exam</a>
        <a href="viewExam.php" target="_self">View Exam</a>
  ...
  <form action="addExamConfig.php" method="POST">
      <div style="display:flex;justify-content:space-evenly;margin-top:15px;">
        ...
        <input type="text" style="background-color:#FE818F;height:36px;cursor: pointer;border-radius: 5px;
      ...
      <select style="background-color:#FE818F;" style="width:250px;margin-left:0px;margin-top:0px;" name="courseID" class="select">
    ...
    <select style="background-color:#FE818F;" style="width:250px;margin-left:0px;margin-top:0px;" name="sectionNum" class="select">
  ...
  <!-- div row-1 ends here -->
    ...
    <select style="background-color:#FE818F;" style="margin-left:0px;width:250px;margin-top:0px;" name="questionCount" class="select">
    ...
    <select style="background-color:#FE818F;" style="width:250px;margin-left:0px;margin-top:0px;" name="semester" class="select">
     ...
     <select style="background-color:#FE818F;" style="width:250px;margin-top:0px;margin-left:0px;" name="year" class="select">
    ...
    <div style="margin-top:15px; width:85%;" class="background">
            ...
            <input type="submit" style="background-color:#FE818F;" style="margin-top:20px;" name="submit" value="Submit" class="submitButton">
