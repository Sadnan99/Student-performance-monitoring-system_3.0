  ...
  <body>
    ...
    <div class="navbar"> 
      ...
      <div class="row1" style="text-align:center;">
        <form method="POST">
         <select style="background-color:#FE818F;" name="year" class="select">
            <option disabled selected>Year</option>
             <option value="2020">2020</option>
             <option value="2021">2021</option>
             <option value="2022">2022</option>
         </select>
             <input style="background:#FE818F;
              border-radius:10px;
              border:none;
              outline:none;
              color:#fff;
      ...
      style="height:50px;display:flex;justify-content:space-around;">
        ...
        <select style="background-color:#FE818F;" name="courseInstructor1" class="select"
        style="margin-left:0px;width:250px;height:100%;margin-top:0px;">
         ...
         <select style="background-color:#FE818F;"name="courseInstructor2" class="select"
            style="margin-left:0px;width:250px;height:100%;margin-top:0px;">
             <option disabled selected>Course Instructor</option>
             <option value="4275">Tahsin F.Ara Nayna</option>
             <option value="4361">Shovasis Kumar Biswas</option>
         ...
         <select style="background-color:#FE818F;" name="courseInstructor3" class="select"
            style="margin-left:0px;width:250px;height:100%;margin-top:0px;">
            <option disabled selected>Course Instructor</option>
             <option value="4275">Tahsin F.Ara Nayna</option>
             <option value="4361">Shovasis Kumar Biswas</option>
      ...
      <button onclick="viewInstructorWise()" style="height: 46px;width: 100px;margin-left:50px;display:inline-block; border-radius: 10px; border: none;outline: none;background:#FE818F;color: #fff;font-size: 14px;letter-spacing:2px;text-transform: uppercase;cursor:pointer;font-weight: bold;">
        view</button>
      </div>
